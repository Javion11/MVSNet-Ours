...
class MVSDataset(Dataset):
    def __init__(self, datapath, listfile, mode, nviews, ndepths=192, interval_scale=1.06, **kwargs):
        # ("/algo/algo/hanjiawei/dtu_training/", '../lists/dtu/train.txt', 'train',3, 128)
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            # hanjiawei:change Rectified to Rectified_noise
...
if __name__ == "__main__":
    ...
    dataset = MVSDataset("/algo/algo/hanjiawei/dtu_training/", '../lists/dtu/train.txt', 'train',
                         3, 128)
    item = dataset[50]

    dataset = MVSDataset("/algo/algo/hanjiawei/dtu_training/", '../lists/dtu/val.txt', 'val', 3,
                         128)
    item = dataset[50]

    dataset = MVSDataset("/algo/algo/hanjiawei/dtu_training/", '../lists/dtu/test.txt', 'test', 5,
                         128)
    item = dataset[50]
