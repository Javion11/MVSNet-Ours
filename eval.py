...
if __name__ == '__main__':   
    ...
    for scan in scans:
        ...
        # hanjiawei:the img used to reconstruct ply file need to be clean ,so choose the clean images or the images generated by net
        if args.imgs == 'clean':
    ...
    """
    # hanjiawei: to multiprocesss args.testpath, args.outdir need to be hardcode seted
